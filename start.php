...
ᗷY:- TOKYO 𖢟 』۝",
    ...
    'reply_markup'=>json_encode([
            'inline_keyboard'=>[
                ...
                [['text'=>'False : '.$false,'callback_data'=>'dghkf'],['text'=>'Not Business 💲: '.$NotBussines,'callback_data'=>'dgdge']],
                    ...
                    if(checkMail($mail)){
                        ...
                        if ($inInsta !== false) {
                            // if($config['filter'] <= $follow){
                                ...
                                $following = $info['ff'];
                                $media = $info['m'];
                                bot('sendMessage', ['disable_web_page_preview' => true, 'chat_id' => $id, 'text' => "🎭𝙷𝙸 𝚃𝙾𝙺𝚈𝙾 𝙽𝙴𝚆 𝙷𝚄𝙽𝚃✅
 𖤓\n━━━━━━━━━━━━
~𝗨𝗦𝗘𝗥 𖡥 :  [$usern]
~𝗘𝗠𝗔𝗜𝗟 𖢰 : [$mail]
~𝗙𝗢𝗟𝗟𝗢𝗪𝗘𝗥𝗦 𝄮 : $follow
~𝗙𝗢𝗟𝗟𝗢𝗪𝗜𝗡𝗚 𖣓 : $following
~𝗣𝗢𝗦𝗧 𖡙 : $media\n- - - - - - - - - - - - - - - - - - - -\nCH :- [ @ARAB_SHIELD 🍎 @SIEEDD]",
