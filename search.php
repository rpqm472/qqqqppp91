...
$search = curl_init(); 
curl_setopt($search, CURLOPT_URL, "https://www.facebook.com/web/search/topsearch/?query=$word1"); 
...
$search = curl_init(); 
curl_setopt($search, CURLOPT_URL, "https://www.facebook.com/web/search/topsearch/?query=$word2"); 
curl_setopt($search, CURLOPT_RETURNTRANSFER, 1);
curl_setopt($search, CURLOPT_ENCODING , "");
curl_setopt($search, CURLOPT_HTTPHEADER, [
				'accept: text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9',
